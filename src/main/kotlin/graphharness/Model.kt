...
data class ClusterSummary(
    ...
    val strategy: String = "package",
    val provenance: String = "package_name",
)

data class SnapshotRuntimeState(
    val snapshot_epoch: Long,
    val graph_age_ms: Long,
...
data class SummaryMapResult(
    ...
    val engine_version: String? = null,
    val build_duration_ms: Long,
    val semantic_level: String = "stable",
...
data class TraversalResult(
    ...
    val engine_version: String? = null,
    val build_duration_ms: Long,
    val semantic_level: String = "best_effort",
    val snapshot_state: SnapshotRuntimeState? = null,
    val snapshot_id: String,
    val generated_at: String,
...
data class CapabilitiesResult(
    ...
    val tool_guarantees: Map<String, String>,
    val stability_guarantees: List<String>,
    val best_effort_guarantees: List<String>,
    val degraded_mode_flags: List<String>,
    val failure_semantics: List<String>,
    val snapshot_semantics: String,
    val clustering_semantics: String,
    val cluster_strategy: String,
    ...
    val snapshot_state: SnapshotRuntimeState,
    val snapshot_id: String,
    val generated_at: String,
)
...
data class SnapshotDeltaResult(
    ...
    val build_duration_ms: Long,
    val semantic_level: String = "best_effort",
    val rebinding_mode: String = "heuristic",
    val snapshot_state: SnapshotRuntimeState? = null,
    val snapshot_id: String,
    val generated_at: String,
)
